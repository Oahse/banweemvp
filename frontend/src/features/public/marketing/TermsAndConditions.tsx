  ...
  return (
    ...
    >
      ...
      <motion.div className="max-w-4xl mx-auto bg-surface p-8 rounded-lg shadow-sm" variants={itemVariants}>
        <Heading level={1} className="text-3xl font-bold text-main mb-6">Terms & Conditions</Heading>
        ...
        <section className="mb-8">
          <Heading level={2} className="text-2xl font-semibold text-main mb-4">2. Intellectual Property</Heading>
          <Body className="text-copy-light mb-4">
        ...
        <section className="mb-8">
          <Heading level={2} className="text-2xl font-semibold text-main mb-4">3. Product Information</Heading>
          <Body className="text-copy-light mb-4">
        ...
        <section className="mb-8">
          <Heading level={2} className="text-2xl font-semibold text-main mb-4">4. Orders and Payments</Heading>
          <Body className="text-copy-light mb-4">
        ...
        <section className="mb-8">
          <Heading level={2} className="text-2xl font-semibold text-main mb-4">5. Shipping and Delivery</Heading>
          <Body className="text-copy-light mb-4">
        ...
        <section className="mb-8">
          <Heading level={2} className="text-2xl font-semibold text-main mb-4">6. Returns and Refunds</Heading>
          <Body className="text-copy-light mb-4">
        ...
        <section className="mb-8">
          <Heading level={2} className="text-2xl font-semibold text-main mb-4">7. Limitation of Liability</Heading>
          <Body className="text-copy-light mb-4">
        ...
        <section className="mb-8">
          <Heading level={2} className="text-2xl font-semibold text-main mb-4">8. Governing Law</Heading>
          <Body className="text-copy-light mb-4">
        ...
        <section>
          <Heading level={2} className="text-2xl font-semibold text-main mb-4">9. Changes to Terms</Heading>
          <Body className="text-copy-light mb-4">
