          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 max-w-sm mx-4">
            ...
            <div className="flex gap-3">
              <button
                ...
                disabled={isLoading}
                className="flex-1 px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-300 dark:hover:bg-gray-600 disabled:opacity-50 text-sm font-medium"
              >
                Cancel
              </button>
              <button
