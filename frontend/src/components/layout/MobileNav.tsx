  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-surface border-t border-border-light z-40">
      <div className="flex justify-between items-center px-4 py-2">
          ...
          <Text as="span" className={`text-xs mt-1 ${isActive('/') ? 'text-primary' : 'text-copy-light'}`}>
            Home
          </Text>
        </Link>
          ...
          <Text as="span" className="text-xs mt-1 text-copy-light">Categories</Text>
        </Button>
          ...
          <Text as="span" className="text-xs mt-1 text-copy-light">Search</Text>
        </Button>
          ...
          <div className="relative">
            ...
            {totalItems > 0 && (
              <Text as="span" className="absolute -top-2 -right-2 bg-primary text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                {totalItems}
              </Text>
            )}
          </div>
          <Text as="span" className={`text-xs mt-1 ${isActive('/cart') ? 'text-primary' : 'text-copy-light'}`}>
            Cart
          </Text>
        </Link>
          ...
          <Text as="span" className={`text-xs mt-1 ${isActive('/account') ? 'text-primary' : 'text-copy-light'}`}>
            Account
          </Text>
        </Link>
      </div>
