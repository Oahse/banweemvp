...
export const LazyImage = ({
  ...
  if (isError) {
    return (
      <div 
        ...
        style={{ width, height }}
      >
        <svg className="w-8 h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-testid="lazy-image-error-svg">
  ...
  return (
    <div className={`relative overflow-hidden ${className}`} style={{ width, height }} data-testid="lazy-image-root">
