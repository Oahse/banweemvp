...
import { CartProvider } from './features/public/cart/contexts/CartContext';
...
const Home = lazy(() => import('./features/public/marketing/Home'));
...
const Cart = lazy(() => import('./features/public/cart/CartPage'));
const Checkout = lazy(() => import('./features/public/checkout/Checkout'));
...
const Contact = lazy(() => import('./features/public/marketing/Contact'));
...
const Support = lazy(() => import('./features/public/marketing/Support'));
