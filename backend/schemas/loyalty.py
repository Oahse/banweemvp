...
class AvailableReward(BaseModel):
    ...
    reward_type: str = Field(..., description="Type of reward (discount, free_product, free_shipping, etc.)")
...
class PersonalizedOffer(BaseModel):
    ...
    offer_type: str = Field(..., description="Type of offer (discount, bonus_points, free_shipping, etc.)")
