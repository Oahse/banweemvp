...
from core.database import BaseModel, GUID, Base # Import Base for association table
...
class Subscription(BaseModel):
    ...
    products = relationship(
        "models.product.ProductVariant", # Points to ProductVariant model
        secondary=subscription_product_association,
        backref="subscriptions_containing",
        lazy="selectin" # Eagerly load products when fetching subscriptions
    )
